...
def main() -> None:
    ...
    elif pagina_ativa == "fontes_dados":
        try:
            pagina_fontes_dados()
        except NameError:
            st.warning("Módulo de fontes de dados indisponível neste build.")
    elif pagina_ativa == "validacao_produtos":
        try:
            pagina_validacao_produtos()
        except NameError:
            st.warning("Módulo de validação indisponível neste build.")
    elif pagina_ativa == "validacao_universal":
        try:
            pagina_validacao_universal()
        except NameError:
            st.warning("Módulo do Motor Universal indisponível neste build.")
