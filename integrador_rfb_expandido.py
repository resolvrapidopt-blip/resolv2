...
# ---------------------------------------------------------------------------
# ALÍQUOTA DE ISS POR UF — FALLBACK ESTÁTICO (LC 116/2003, máx 5%)
# ---------------------------------------------------------------------------

def consultar_aliquota_iss(uf: str, cod_ibge: str = "") -> "Decimal":
    """
    Retorna alíquota de ISS para o município/UF.
    Usa tabela estática de alíquotas médias por UF (entre 2% e 5%).
    Fonte: LC 116/2003 + legislação municipal consolidada.
    Em versão futura, pode consultar API da RFB ou IBGE para alíquota exata.
    """
    from decimal import Decimal
    ALIQUOTA_ISS_UF = {
        "AC": "3.0", "AL": "5.0", "AP": "3.0", "AM": "5.0", "BA": "5.0",
        "CE": "5.0", "DF": "5.0", "ES": "5.0", "GO": "5.0", "MA": "5.0",
        "MT": "5.0", "MS": "5.0", "MG": "5.0", "PA": "5.0", "PB": "5.0",
        "PR": "5.0", "PE": "5.0", "PI": "5.0", "RJ": "5.0", "RN": "5.0",
        "RS": "5.0", "RO": "5.0", "RR": "3.0", "SC": "5.0", "SP": "5.0",
        "SE": "5.0", "TO": "5.0",
    }
    return Decimal(ALIQUOTA_ISS_UF.get(uf.upper().strip(), "5.0"))
